  ...
  state: assignDeep(
    {
      ...
      placeholderStyle: 'font-size:13px; color:var(--grey-9); font-weight:300',
      placeholderStyleIdent: 'font-size:18px; color:var(--grey-9); font-weight:300; letter-spacing: initial;',
